...
export function ComponentPreview({
  ...
  try {
    ...
    } else if (name === "latency-flame-compact-demo") {
      const LatencyFlameCompactDemo =
        require("@/registry/default/example/latency-flame-compact-demo").default
      Component = LatencyFlameCompactDemo
    }
  } catch (error) {
...
export type { TraceSpan, TraceBreadcrumbProps }`,
  "latency-flame-compact-demo": `"use client"
...
const sampleTrace: TraceSpan[] = [
  {
    ...
    children: [
      { id: "1a", name: "Cache Read", startTime: 5, duration: 45, depth: 1 },
      {
        ...
        depth: 1,
        children: [
          { id: "1b1", name: "Verify Token", startTime: 60, duration: 25, depth: 2 },
        ],
      },
    ],
  },
  {
    ...
    depth: 0,
    children: [
      { id: "2a", name: "Parse JSON", startTime: 190, duration: 30, depth: 1 },
      {
        id: "2b",
        ...
        depth: 1,
        children: [
          { id: "2b1", name: "Type Check", startTime: 230, duration: 35, depth: 2 },
        ],
      },
    ],
  },
  {
    ...
    depth: 0,
    children: [
      { id: "3a", name: "Connection Pool", startTime: 290, duration: 15, depth: 1 },
      {
        id: "3b",
        name: "Execute Query",
        startTime: 310,
        ...
        children: [
          {
            ...
            depth: 2,
            children: [
              { id: "3b1a", name: "Disk I/O", startTime: 320, duration: 25, depth: 3 },
            ],
          },
          { id: "3b2", name: "Sort Results", startTime: 360, duration: 15, depth: 2 },
        ],
      },
    ],
  },
    ...
    children: [
      {
        ...
        depth: 1,
        children: [
          { id: "4a1", name: "TLS Handshake", startTime: 414, duration: 12, depth: 2 },
          { id: "4a2", name: "Response Parse", startTime: 430, duration: 10, depth: 2 },
        ],
      },
    ],
  },
